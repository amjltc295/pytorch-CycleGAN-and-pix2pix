...
def get_video_transform(opt):
    ...
    if opt.resize_or_crop == 'resize_and_crop':
        ...
        transform_list.append(vtransforms.Resize(osize, Image.BICUBIC))
        transform_list.append(vtransforms.RandomCrop(opt.fineSize))
    elif opt.resize_or_crop == 'crop':
        transform_list.append(vtransforms.RandomCrop(opt.fineSize))
    elif opt.resize_or_crop == 'scale_width':
        transform_list.append(vtransforms.Lambda(
